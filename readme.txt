...
Tags: woocommerce, pagseguro, payment, parceled, installments
...
= Em Português Brasil =
Trata-se de um pequeno sistema para exibir o parcelamento sem juros pré-configurado no Painel Administrativo WordPress usando o plugin Woocommerce PagSeguro. O plugin foi criado para melhorar a experiência do cliente final exibindo no loop dos produtos o cálculo.
