...
class WC_PagSeguro_Gateway extends WC_Payment_Gateway {
	...
	public function __construct() {
		...
		$this->installment       			= $this->get_option( 'installment' ); //installment payment (parcelamento) 
		$this->installment_single_product   = $this->get_option( 'installment_single_product' ); //installment payment (parcelamento) 
